                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        $sql = "SELECT * FROM registrationresellerplant where cust_type = 'traidor/reseller'  ORDER BY registrationresellerplant.id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["gst_pan"] ?></td>

                                                <td><?php echo $row["fssai_lic"] ?></td>

                                                <td><?php echo $row["msme_regi"] ?></td>

                                                <td><?php echo $row["cust_type"] ?></td>

                                                <td class="text-right">
                                                    <div class="actions">
                                                        <a href="viewvendorpayment.php?id=<?php echo $row["id"] ?>"
