...
<body>
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">All Patment Details</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">All Payment Details</li>
                            </ul>
                        </div>
    ...
    // Make sure $user_id is properly defined before using it in the query
    $user_id = mysqli_real_escape_string($conn, $user_id);

    $sql = "SELECT * FROM approval
    JOIN payment ON approval.user_id = payment.user_id
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($row["maincategory"]) ?></td>
                                                <td><?= htmlspecialchars($row["category1"]) ?></td>
                                                <td><?= htmlspecialchars($row["name"]) ?></td>
                                                <td><?= htmlspecialchars($row["address"]) ?></td>
                                                <td><?= htmlspecialchars($row["quantity_required"]) ?></td>
                                                <td><?= htmlspecialchars($row["request_percentage"]) ?></td>
                                                <td><?= htmlspecialchars($row["commision_amount"]) ?></td>
