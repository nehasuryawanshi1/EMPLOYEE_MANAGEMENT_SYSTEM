            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">All Employee</h3>
                            <ul class="breadcrumb">
                        ...
                        <!-- <div class="col-auto text-right float-right ml-auto">
                            <a href="addemployee.php" class="btn btn-primary">Add Employee <i
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM new_employee where id='$id' ORDER BY new_employee.id DESC";
